...
export function HomePage() {
  ...
  const apps = [
    {
      title: "Exam Creator",
      description:
        "Build and manage exams, review attempts, and track metrics.",
      href: "/exam-creator",
      color:
    ...
    },
    {
      title: "Team Board",
      description:
        "Collaborate with your team, track progress, and manage projects.",
      href: "/team-board",
      color:
    ...
    {
      title: "Task Tracker (Beta)",
      description:
        "Generate AI-powered activity reports and share them with your organisation.",
      href: "/task-tracker",
      color:
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Top nav */}
      <header className="flex items-center justify-end gap-3 px-6 py-3 border-b border-gray-200 dark:border-gray-800">
        <Link
          to="/settings"
